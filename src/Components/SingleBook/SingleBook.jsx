const SingleBook = ({ book }) => {
    ...
    return (
        <div className="group relative bg-white border border-gray-100 rounded-[2rem] p-5 hover:border-[#23BE0A50] transition-all duration-500 hover:shadow-[0_20px_50px_rgba(0,0,0,0.05)] cursor-pointer flex flex-col h-full">
            ...
            <div className="relative overflow-hidden bg-[#F3F3F3] rounded-[1.5rem] py-10 mb-6 flex justify-center items-center">
                ...
                />
                {/* Floating "New" or Category badge for extra 'pop' */}
